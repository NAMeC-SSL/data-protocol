...
_MAINBOARDTODRIBBLER = DESCRIPTOR.message_types_by_name['MainBoardToDribbler']
...
MainBoardToBrushless = _reflection.GeneratedProtocolMessageType('MainBoardToBrushless', (_message.Message,), {
  ...
  '__module__' : 'ssl_data_pb2'
  # @@protoc_insertion_point(class_scope:MainBoardToBrushless)
  })
_sym_db.RegisterMessage(MainBoardToBrushless)

MainBoardToDribbler = _reflection.GeneratedProtocolMessageType('MainBoardToDribbler', (_message.Message,), {
  'DESCRIPTOR' : _MAINBOARDTODRIBBLER,
  '__module__' : 'ssl_data_pb2'
  # @@protoc_insertion_point(class_scope:MainBoardToDribbler)
  })
_sym_db.RegisterMessage(MainBoardToDribbler)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _COMMANDS._serialized_start=565
  _COMMANDS._serialized_end=605
  _KICKER._serialized_start=607
  _KICKER._serialized_end=650
  _MAINBOARDTOBRUSHLESS._serialized_start=18
  _MAINBOARDTOBRUSHLESS._serialized_end=83
  _MAINBOARDTODRIBBLER._serialized_start=85
  _MAINBOARDTODRIBBLER._serialized_end=149
  _BRUSHLESSTOMAINBOARD._serialized_start=151
  _BRUSHLESSTOMAINBOARD._serialized_end=218
  _IATOMAINBOARD._serialized_start=221
  _IATOMAINBOARD._serialized_end=429
  _MAINBOARDTOIA._serialized_start=432
  _MAINBOARDTOIA._serialized_end=563
